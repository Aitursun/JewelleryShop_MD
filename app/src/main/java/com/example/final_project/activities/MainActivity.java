...
import com.example.final_project.services.MusicService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Добавление слушателей для кнопок воспроизведения и остановки музыки
    ...
    void initCategories() {
        ...
        // Use LinearLayoutManager with horizontal orientation for the categories list
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        binding.categoriesList.setLayoutManager(horizontalLayoutManager);
